...
# Peso de cada payaso 112 g
# Peso de cada muñeca 75 g

pesoPayaso = 112
pesoMuñeca = 75

pesoTotalDe23Payasos = pesoPayaso * 23
pesoTotalDe54Muñecas = pesoMuñeca * 54
pesoTotal = pesoTotalDe23Payasos + pesoTotalDe54Muñecas

print("El precio total de los payasos y muñeas es de: " + str(pesoTotal) + " g")